...
BEGIN_DATADESC( CWeaponAR2Retail )
...
IMPLEMENT_SERVERCLASS_ST(CWeaponAR2Retail, DT_WeaponAR2Retail)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_ar2_retail, CWeaponAR2Retail );
PRECACHE_WEAPON_REGISTER(weapon_ar2_retail);

acttable_t	CWeaponAR2Retail::m_acttable[] = 
{
...
IMPLEMENT_ACTTABLE(CWeaponAR2Retail);

CWeaponAR2Retail::CWeaponAR2Retail( )
{
	m_fMinRange1	= 65;
	m_fMaxRange1	= 2048;
...
void CWeaponAR2Retail::Precache( void )
{
	BaseClass::Precache();
...
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::ItemPostFrame( void )
{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponAR2Retail::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
//			nDamageType - 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::DoImpactEffect( trace_t &tr, int nDamageType )
{
	CEffectData data;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::DelayedAttack( void )
{
	...
	// Decrease ammo
	pOwner->RemoveAmmo( 10, m_iSecondaryAmmoType );     //1
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::SecondaryAttack( void )
{
	if ( m_bShotDelayed )
		return;
...
//-----------------------------------------------------------------------------
bool CWeaponAR2Retail::CanHolster( void )
{
	if ( m_bShotDelayed )
		return false;
...
// Purpose: Override if we're waiting to release a shot
//-----------------------------------------------------------------------------
bool CWeaponAR2Retail::Reload( void )
{
	if ( m_bShotDelayed )
		return false;
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::FireNPCSecondaryAttack( CBaseCombatCharacter *pOperator, bool bUseWeaponAngles )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::Operator_ForceNPCFire( CBaseCombatCharacter *pOperator, bool bSecondary )
{
	if ( bSecondary )
	{
...
//			*pOperator - 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{ 
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponAR2Retail::AddViewKick( void )
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponAR2Retail::GetProficiencyValues()
{
